  ...
  return (
    <header className="flex items-center justify-between p-4 mb-6 bg-white border-b shadow-sm rounded-t-xl">
      <div className="flex items-center gap-2">
        ...
        <div>
          <h1 className="text-xl font-bold tracking-tight text-primary">ATM Simulator</h1>
          <p className="text-xs text-muted-foreground font-medium uppercase tracking-widest">Simulator</p>
        </div>
      </div>
