      ...
      <Card className="lg:col-span-8 bg-gradient-to-br from-primary to-primary/80 text-primary-foreground border-none shadow-2xl overflow-hidden relative">
        ...
        <CardHeader className="relative z-10 pb-0">
          <CardTitle className="text-primary-foreground/80 font-medium text-lg flex items-center gap-2">
            <Wallet size={20} />
            Savings Account: {userProfile.accountNumber}
          </CardTitle>
        </CardHeader>
        ...
        {qrCode ? (
          <div className="space-y-4 animate-in zoom-in duration-300">
             ...
             <div>
                ...
                <p className="text-[10px] text-muted-foreground mt-1">Scan at any ATM Simulator for Cardless Cash</p>
             </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card className="bg-white border-none shadow-xl">
                <CardHeader>
                  ...
                  <CardDescription>Securely transfer to other ATM Simulator accounts.</CardDescription>
                </CardHeader>
                <CardContent>
